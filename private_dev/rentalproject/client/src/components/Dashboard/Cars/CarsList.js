...
const CarsList = ({ searchQuery }) => {
  ...
  const handleDeleteClick = () => {
    ...
    axios
      .delete("http://localhost:8080/deletecars", {
  ...
  return (
    <>
      ...
      >
        <MuiAlert elevation={6} variant="filled" severity={snackbarData.title}>
                  ...
                  >
                    ...
                    <TableCell align="right">
                      <Button
                        variant="outlined"
                        color="primary"
                        onClick={() => setSelectedCarForEdit(row)}
                      >
                        Edit
                      </Button>
                    </TableCell>
